...
const SkillsSection: React.FC = () => {
  const skillCategories: SkillCategory[] = [
    ...
    },
    {
      ...
      skills: [
        { name: "PostgreSQL", icon: <img src="/icons/database/psql.svg" alt="PostgreSQL" /> },
        ...
        { name: "MySQL", icon: <img src="/icons/database/sql.svg" alt="MySql" /> },
    ...
    },
    {
      ...
      skills: [
        ...
        // { name: "Cloudflare", icon: <img src="/icons/cloud/cloudflare.svg" alt="Cloudflare" /> },
